        ...
        <AccordionItem border="none">
          ...
          >
            ...
            >
              ...
              <AccordionIcon fontSize="24px" color={fontColors.secondary} />
            </AccordionButton>

            {/* Content */}
            <AccordionPanel px={6} pb={6}>
              <Text lineHeight="1.8" color={textColor} fontSize="md">
                I started my career at Aptech E-Learning. It was a life-changing
